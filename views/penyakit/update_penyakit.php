                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="keterangan" type="text" class="form-control" name="keterangan" maxlength="1000" value="<?= $row['keterangan'] ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="solusi">Solusi</label>
                                    <input id="solusi" type="text" class="form-control" name="solusi" maxlength="500" value="<?= $row['solusi'] ?>" required>
                                </div>
